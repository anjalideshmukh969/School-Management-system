...
const STATUS_COLORS = { present: "text-green-700 bg-green-50", absent: "text-red-700 bg-red-50", late: "text-amber-700 bg-amber-50", leave: "text-gray-700 bg-gray-100" };
const MyAttendance = () => {
  const [data, setData] = useState(null);
  useEffect(() => { api.get("/attendance/me").then(({ data }) => setData(data)); }, []);
  const columns = [
